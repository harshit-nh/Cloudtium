package com.example.cloudtium.Adapters;
...
public class FutureAdapter extends RecyclerView.Adapter<FutureAdapter.viewHolder> {
    ...
    public FutureAdapter(ArrayList<FutureDomain> items, Context context) {
        this.items = items;
    ...
    public FutureAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.viewholder_future,parent,false);
    ...
    public void onBindViewHolder(@NonNull FutureAdapter.viewHolder holder, int position) {
        ...
        int drawableResourceId = holder.itemView.getResources().getIdentifier(items.get(position)
                .getPicPath(),"drawable",holder.itemView
